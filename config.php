...
/**
 * Theme Boost Union Med2 Child - Theme config
 *
...
// This move will save us from duplicating all lines from Boost Union's config.php into Boost Union Med2 Child's config.php.
...
// Then, we require Boost Union Med2 Child's locallib.php to make sure that it's always loaded.
require_once($CFG->dirroot . '/theme/boost_union_med2/locallib.php');

// Next, we overwrite only the settings which differ between Boost Union and Boost Union Med2 Child.
$THEME->name = 'boost_union_med2';
$THEME->scss = function($theme) {
    return theme_boost_union_med2_get_main_scss_content($theme);
};
$THEME->parents = ['boost_union','boost'];
$THEME->extrascsscallback = 'theme_boost_union_med2_get_extra_scss';
$THEME->prescsscallback = 'theme_boost_union_med2_get_pre_scss';
...
// Lastly, we replicate some settings from Boost Union at runtime into Boost Union Med2 Child's settings.
...
// it would be quite ugly to duplicate all of these settings again to Boost Union Med2 Child.
